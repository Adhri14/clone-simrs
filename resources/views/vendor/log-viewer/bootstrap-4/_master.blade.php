...
<head>
    ...
    {{-- Styles --}}
    <link rel="stylesheet" href="{{ asset('vendor/laravel-log/bootstrap.min.css') }}"
        integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href="{{ asset('vendor/laravel-log/font-awesome.min.css') }}">
    <style>
        html {
            position: relative;
            min-height: 100%;
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark sticky-top bg-dark p-0">
        <a href="{{ route('home') }}" class="navbar-brand mr-0">
            <i class="fa fa-fw fa-book"></i> SIMRS Laravel
        </a>
            ...
            <ul class="navbar-nav mr-auto">
                <li class="nav-item {{ Route::is('log-viewer::dashboard') ? 'active' : '' }}">
                    <a href="{{ route('log-viewer::dashboard') }}" class="nav-link">
                        <i class="fa fa-dashboard"></i> Log Viewer
                    </a>
                </li>
    ...
    <footer class="main-footer">
        <div class="container-fluid">
            ...
            <p class="text-muted pull-right">
                Created by Marwan Dhiaur Rahman 2022<sup>&copy;</sup>
            </p>
        </div>
    </footer>

    {{-- Scripts --}}
    <script src="{{ asset('vendor/laravel-log/jquery-3.2.1.min.js') }}" crossorigin="anonymous"></script>
    <script src="{{ asset('vendor/laravel-log/popper.min.js') }}" crossorigin="anonymous"></script>
    <script src="{{ asset('vendor/laravel-log/bootstrap.min.js') }}" crossorigin="anonymous"></script>
    <script src="{{ asset('vendor/laravel-log/Chart.min.js') }}"></script>
